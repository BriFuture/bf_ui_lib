 ...
 */
//    static const QColor
const QVector<QColor> Material::palette = {
    ...
    QtMaterialThemePrivate::rgba(0, 0, 0, 0),
    QtMaterialThemePrivate::rgba(0, 0, 0, 1),
    QtMaterialThemePrivate::rgba(0, 0, 0, 0.87),
    QtMaterialThemePrivate::rgba(0, 0, 0, 0.54),
    QtMaterialThemePrivate::rgba(0, 0, 0, 0.26),
    QtMaterialThemePrivate::rgba(0, 0, 0, 0.12),
    QtMaterialThemePrivate::rgba(255, 255, 255, 1),
    QtMaterialThemePrivate::rgba(255, 255, 255, 0.87),
    QtMaterialThemePrivate::rgba(255, 255, 255, 0.54)
};
...
void QtMaterialTheme::setColor(const QString &key, Material::Color color)
{
    ...
    d->colors.insert(key, Material::palette[color]);
}
